 ...
 *
 * TODO before launch: confirm email and final domain.
 */
...
export const siteConfig = {
  ...
  instagram: {
    handle: "@alterique.uk",
    href: "https://www.instagram.com/alterique.uk",
  },
  ...
  google: {
    // Checked against the Business Profile on 10 Sept 2026. Set
    // GOOGLE_PLACES_API_KEY + GOOGLE_PLACE_ID (see lib/google-reviews.js) and
    // these become the fallback rather than the figures on show.
    rating: "5.0",
    reviewCount: 102,
